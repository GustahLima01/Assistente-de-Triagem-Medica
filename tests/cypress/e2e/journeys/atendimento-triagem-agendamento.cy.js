...
describe("Frontend - jornada E2E de atendimento", () => {
  ...
  it("inicia atendimento, registra triagem e confirma agendamento para o dia atual", () => {
    ...
    cy.seed("symptom", {
      name: "Dor no peito Jornada",
      description: "Sintoma preparado para a jornada E2E.",
      severity: "HIGH",
      specialty: "Cardiologia"
    });
    cy.seed("symptom", {
      name: "Falta de ar Jornada",
      description: "Segundo sintoma preparado para a jornada E2E.",
      severity: "MEDIUM",
      specialty: "Cardiologia"
    });
    cy.seed("doctor", {
      ...
      specialty: "Cardiologia",
      phone: "+5511999990000",
      email: "medico.jornada@clinica.local"
    });
